...
public class DistributorService : IDistributorService
{
    ...
    private static readonly SemaphoreSlim _addDistributorLock = new(1, 1);
    ...
    {
        await _addDistributorLock.WaitAsync(); // Lock ensures that recommendation rules are followed correctly
        try
        {
